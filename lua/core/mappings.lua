...
if is_available "toggleterm.nvim" then
  ...
  if vim.fn.executable "gitui" == 1 then
    maps.n["<leader>gg"] = { function() toggle_term_cmd "gitui" end, desc = "ToggleTerm lazygit" }
    maps.n["<leader>tl"] = { function() toggle_term_cmd "gitui" end, desc = "ToggleTerm lazygit" }
  end
